...
class BrandsDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('avatar', function (Brand $brand) {
                return view('pages.brands.columns._brand', compact('brand'));
            ...
            ->addColumn('action', function (Brand $brand) {
                return view('pages.brands.columns._actions', compact('brand'));
            })
            ->setRowId('id');
    }
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
            ...
            ->orderBy(2)
            ->drawCallback("function() {" . file_get_contents(resource_path('views/pages//brands/columns/_draw-scripts.js')) . "}");
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('avatar')->title('Logo')->addClass('text-nowrap'),
